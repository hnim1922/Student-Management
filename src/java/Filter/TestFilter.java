...
public class TestFilter implements Filter {
    ...
    private static final String HEADERPAGE = "header.jsp";
    public TestFilter() {
    }    
            ...
            if (resource.length()>0){
                if (username!=null){
                    if (username.equals("Admin")){
                        ...
                        if (resource.contains("Class") || resource.contains("Score") || resource.contains("Student") || resource.contains("Subject")|| resource.contains("Teacher")){
                            request.setAttribute("ERRORNOTADMIN", "Get out!");
                        } else {
                            url = resource;
                            if (resource.lastIndexOf(".jsp") > 0|| resource.lastIndexOf(".html")>0){
                                url=resource;
