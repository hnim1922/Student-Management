...
<html>
    ...
    <body>
        <c:set var="t" value="${requestScope.tObject}"/>
        ...
        <table width="600px" border="0px solid">
            <form action="TeacherServlet" method="POST" name="f1">
                ...
                <tr> 
                    <td>Last Name </td> 
                    <td>: <input type="text" name="lname" value="${t.ln}" /><font color="red">${requestScope.errorLastName}</font></td> 
                </tr>
                <tr> 
                    <td>First Name </td> 
                    <td>: <input type="text" name="fname" value="${t.fn}" /><font color="red">${requestScope.errorFirstName}</font></td> 
                </tr>
                <tr> 
        ...
        <br> <br>
        <a href="TeacherServlet"> List of Teachers </a>
    </body>
</html>
