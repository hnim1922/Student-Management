...
<html>
    ...
    <body>
        <c:set var="su" value="${requestScope.suObject}"/>
        ...
        <table width="600px" border="0px solid">
            <form action="SubjectServlet" method="POST" name="f1">
                <input type="hidden" name ="action" value="${action}">
                <tr> 
                    <td>Subject ID </td> 
                    <c:if test="${su.id!=''}">
                        <td>: <input type="text" name="id" value="${su.id}" readonly/></td> 
                    </c:if>
                    <c:if test="${su.id==''}">
                ...
                <tr> 
                    <td>Name </td> 
                    <td>: <input type="text" name="name" value="${su.name}" /><font color="red">${requestScope.errorName}</font></td> 
                </tr>
                <tr> 
        ...
        <br> <br>
        <a href="SubjectServlet"> List of Subjects </a>
    </body>
</html>
